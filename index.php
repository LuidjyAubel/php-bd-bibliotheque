...
<div class="container">
  <div class="row">
    ...
    while($donnees = mysqli_fetch_assoc($resultat)){
        ...
        echo "<tr> <th> libellé </th> <th colspan='3'> action </th>  </tr>" ;
      
        //--- Connection au SGBDR include('conf.php');

        include('connect.php');
        //--- Préparation de la requête
        $Requete = "Select * From type_livre2" ;
        ...
        $libelle = $ligne['libelle'];
          ...
          echo '<td><a class="btn btn-primary" href="detail.php?id=' . $id .'&'.$libelle.' "> Voir </a></td>';
		  echo '<td><a class="btn btn-info" href="edit.php?id=' . $id .'">Modifier</a></td>';
          echo '<td><a class="btn btn-danger" href="del.php?id=' . $id .'">Supprimer</a></td>';
